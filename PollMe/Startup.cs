...
namespace PollMe
{
    public class Startup
    {
        ...
        {
            services.AddEntityFrameworkSqlServer().AddDbContext<PollMeContext>(options => options.UseSqlServer(Configuration.GetConnectionString("PollMeContext"))).AddOptions();
